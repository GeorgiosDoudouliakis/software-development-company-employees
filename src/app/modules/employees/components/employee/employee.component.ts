...
export class EmployeeComponent implements OnInit, OnDestroy {
  ...
  openEdit(employee: Employee) {
    const { firstName, lastName, contractType, speciality, frontEndFramework, projects } = employee;

    const dialogRef = this.dialog.open(AddEmployeeDialogComponent, {
      width: '400px',
      data: { action: 'edit', firstName, lastName, contractType, speciality, frontEndFramework, projects }
    })
